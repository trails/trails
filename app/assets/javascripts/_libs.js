...
var SelectedElements = Class.create({
  ...
  _add: function (elementsOrSelector) {
    if(Object.isArray(elementsOrSelector)) {
      elementsOrSelector.each(this._add, this);
    }
    if(Object.isElement(elementsOrSelector)) {
      this.elements.push(elementsOrSelector);
    }
    if(Object.isString(elementsOrSelector)) {
      this.selectors.push(elementsOrSelector);
    }
  },
  ...
  observe: function (event) {
    ...
    callbacks.each(function (callback) {
      ...
      this.selectors
        .collect(Element.match.argMap($1.invoke('element'), $iterator), Element.match)  // -> filtering functions 
